...
= Spring Cloud Stream
include::{basedir}/stream/spring-cloud-stream-docs/src/main/asciidoc/spring-cloud-stream-overview.adoc[]

= Spring Cloud Task
include::{basedir}/task/spring-cloud-task-docs/src/main/asciidoc/getting-started.adoc[leveloffset=+1]
include::{basedir}/task/spring-cloud-task-docs/src/main/asciidoc/features.adoc[leveloffset=+1]
