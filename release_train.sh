...
RELEASE_TRAIN_PROJECTS=${RELEASE_TRAIN_PROJECTS:-aws bus cloudfoundry commons contract config netflix security consul sleuth stream task zookeeper vault gateway function}
