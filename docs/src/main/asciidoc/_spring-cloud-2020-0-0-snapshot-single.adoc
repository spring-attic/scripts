...
include::_spring-cloud-2020-0-0-snapshot-attributes.adoc[]
...
include::{basedir}/stream-core/src/main/asciidoc/spring-cloud-stream.adoc[leveloffset=+1]

:project-root: {basedir}/stream-binder-rabbit
:project-version: {spring-cloud-stream-version}
include::{basedir}/stream-binder-rabbit/src/main/asciidoc/spring-cloud-stream.adoc[leveloffset=+1]

:project-root: {basedir}/stream-binder-kafka
:project-version: {spring-cloud-stream-version}
include::{basedir}/stream-binder-kafka/src/main/asciidoc/spring-cloud-stream.adoc[leveloffset=+1]

= Appendix: Compendium of Configuration Properties

include::_spring-cloud-2020-0-configprops.adoc[leveloffset=+1]
