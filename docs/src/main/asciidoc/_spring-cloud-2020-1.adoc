...
include::_spring-cloud-2020-1-attributes.adoc[]
...
include::_spring-cloud-2020-1-links.adoc[]

= Appendix: Compendium of Configuration Properties

link:spring-cloud-2020-1-configprops.html[Spring Cloud 2020-1 configuration properties]
