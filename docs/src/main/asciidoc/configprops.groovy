...
@Grab('org.springframework.cloud:spring-cloud-starter-config:1.3.1.RELEASE')
@Grab('org.springframework.cloud:spring-cloud-config-server:1.3.1.RELEASE')
@Grab('org.springframework.cloud:spring-cloud-netflix-eureka-server:1.3.1.RELEASE')
@Grab('org.springframework.cloud:spring-cloud-starter-eureka:1.3.1.RELEASE')
...
@Grab('org.springframework.cloud:spring-cloud-starter-sleuth:1.2.1.RELEASE')
...
@Grab('org.springframework.cloud:spring-cloud-contract-stub-runner:1.1.1.RELEASE')
@Grab('org.springframework.cloud:spring-cloud-vault-config:1.0.1.RELEASE')
@Grab('org.springframework.cloud:spring-cloud-vault-config-aws:1.0.1.RELEASE')
@Grab('org.springframework.cloud:spring-cloud-vault-config-databases:1.0.1.RELEASE')
@Grab('org.springframework.cloud:spring-cloud-vault-config-consul:1.0.1.RELEASE')
@Grab('org.springframework.cloud:spring-cloud-vault-config-rabbitmq:1.0.1.RELEASE')
