...
:docs-url: https://cloud.spring.io/spring-cloud-static/{spring-cloud-version}
...
* Chat with us at http://https://gitter.im/spring-cloud/spring-cloud[{project-full-name} Gitter]
